...
export const DEMO_COURSES: DemoCourse[] = [
  {
    ...
    code: "CRS-PY-401",
    description: "Deep dive into async IO, memory profiling, metaprogramming, and scalable backend API development in Python.",
    category: "Technical / Programming",
  ...
  },
  {
    ...
    code: "CRS-ML-402",
    description: "Master feature engineering, cross-validation, ensemble modeling, PyTorch basics, and ML pipeline deployment.",
    category: "Data & AI",
  ...
  {
    id: "course-jv-401",
    title: "Enterprise Java Architecture with Spring Boot",
    code: "CRS-JV-401",
    description: "Building production-grade microservices, distributed transaction management, reactive streams, and JVM performance tuning.",
    category: "Technical / Programming",
